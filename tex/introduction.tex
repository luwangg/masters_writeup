...
\end{wrapfigure}
MeerKAT is a 64-dish radio telescope, aimed at being the precursor to the full Square Kilometer Array (SKA) \nomenclature{SKA}{Square Kilometer Array} radio telescope. At the time of writing, the KeerKAT array is in the process of being rolled out, with around 6 dishes being operational at present.
...
The presence of Radio Frequency Interference (RFI) \nomenclature{RFI}{Radio Frequency Interference} could interfere with the ability of the telescope to do science, or even destroy the sensitive amplifiers and digitisers designed to cope with only very weak signals.
...
Specifically, a device capable of detecting RFI and performing \nomenclature{AoA}{Angle of Arrival} parameter estimation on them. 
The process of ascertaining the AoA of RF is known as \nomenclature{DF}{Direction Finding}.
