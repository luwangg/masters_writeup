...
\section{DF From Electronic warfare target location methods}
...
\section{Amplitude Comparison Methods from electronic target location method}
...
\section{MSE Phase Interferometery from ewtlkm}
...
Also graphically in \cref{fig:lit-review-doppler-switching} is this typical implementation of a Doppler DF system using antenna switching.
...
The simples phase interferometry system is a two element array. This is shown graphically in \cref{fig:lit-two-element-phase} where \(d\) is the element spacing, \(\lambda\) is the wavelength and \(\theta\) is the AoA or difference between the boresight and wavevector.
