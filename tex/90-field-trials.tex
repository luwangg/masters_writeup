...
\begin{figure}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth, clip=true, trim=0 0 140 0]{field-trials/multipath-phase-shift}
  \end{subfigure}\\[2ex]
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=\textwidth, clip=true, trim=0 0 140 0]{field-trials/multipath-amplitude-shift}
