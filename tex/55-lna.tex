...
\begin{figure}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{zfl500-10-3000}
    \caption{Gain from 0 to \SI{3}{\giga\hertz} in dB. Antialisaing is sufficient}
  \end{subfigure}\\[1em]
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.9\textwidth]{zfl500-10_500-mag-db}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{zfl500-10-500-phase}
