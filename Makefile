...
#  -shell-scape is necessary for the svg package to work... :-/
# missing file reference and interactively asking you for an alternative.

main.pdf: 
	latexmk -outdir=out -auxdir=out -pdf -logfilewarninglist -file-line-error -use-make -pdflatex="pdflatex -shell-escape %O %S"  main.tex
